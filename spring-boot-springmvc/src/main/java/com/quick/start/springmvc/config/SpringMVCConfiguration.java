package com.quick.start.springmvc.config;

import com.quick.start.springmvc.core.interceptor.FirstInterceptor;
import com.quick.start.springmvc.core.interceptor.SecondInterceptor;
import com.quick.start.springmvc.core.interceptor.ThirdInterceptor;
...
public class SpringMVCConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        // 拦截器二
        registry.addInterceptor(this.secondInterceptor()).addPathPatterns("/users3/current_user");
        // 拦截器三
